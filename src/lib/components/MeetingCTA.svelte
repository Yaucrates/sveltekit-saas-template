...
<div class="mx-6 my-6 rounded-3xl bg-stone-900 text-white overflow-hidden relative">
    ...
    <div class="max-w-6xl mx-auto px-12 py-24 relative z-10 flex flex-col md:flex-row justify-between items-center gap-12">
        ...
        <div class="flex flex-col items-center gap-4">
            <a href="https://calendly.com/abdulhusseinyousifh/30min" class="inline-block bg-white text-stone-900 px-8 py-4 rounded-sm font-semibold hover:bg-blue-50 transition-all shadow-lg hover:shadow-xl duration-200">
                Book a meeting
            </a>
