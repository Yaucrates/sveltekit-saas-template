...
<section bind:this={heroSection} class="max-w-6xl mx-auto px-12 py-24">
    <div class="max-w-3xl">
        <h1 class="text-6xl tracking-tighter leading-[1.1] font-normal mb-8 text-stone-900">
            Meet Your <span class="text-nowrap">All-in-One</span>
...
<section class="border-y border-stone-200 bg-white py-12">
    <p class="text-sm font-medium text-stone-500 text-center mb-8">Trusted by educators at</p>
    <div class="max-w-6xl mx-auto px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 items-center text-stone-400 grayscale opacity-70 gap-8">
        <span class="font-brand font-bold text-lg tracking-widest text-center">SCHS</span>
        <span class="font-brand font-bold text-lg text-center">UNIVERSITY OF TENNESSEE</span>
        <span class="font-brand font-bold text-lg text-center">MARYVILLE COLLEGE</span>
        <span class="font-brand font-bold text-lg text-center">BELMONT</span>
    </div>
</section>
